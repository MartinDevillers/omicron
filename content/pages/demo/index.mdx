...
All three algorithms show a solid linearithmic run time for all sizes of N. Merge Sort shows this pattern the most, while Heap Sort sometimes leans towards a more linear runtime. Tim Sort shows the best results as a significant number of runs require a linear amount of operations to solve. This comes as no surprise: Tim Sort is a highly sophisticated algorithm that performs well on data sets that are (partially) sorted. In fact, it performs so well that it has become the default sorting implementation in popular programming languages like [Java](https://download.java.net/java/GA/jdk14/docs/api/java.base/java/util/Arrays.html#sort(java.lang.Object%5B%5D)) and [Python](https://svn.python.org/projects/python/trunk/Objects/listsort.txt). Tim Sort also powers JavaScript's `Array#sort()` in [Chromium's V8 JavaScript engine](https://github.com/v8/v8/blob/4b9b23521e6fd42373ebbcb20ebe03bf445494f9/third_party/v8/builtins/array-sort.tq).
