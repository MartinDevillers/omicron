...
<ComplexityChart title="Time complexity of Bubble Sort on a sorted list of numbers">
    <ComplexitySeries/>
    <AnalysisSeries algorithms={[Algorithms.bubbleSort]} dataSets={[DataSets.sorted]}/>
</ComplexityChart>
...
<ComplexityChart title="Time complexity of Bubble Sort on a random list of numbers">
    <ComplexitySeries/>
    <AnalysisSeries algorithms={[Algorithms.bubbleSort]} dataSets={[DataSets.random]}/>
</ComplexityChart>
...
<ComplexityChart title="Time complexity of Bubble Sort on a reversed list of numbers">
    <ComplexitySeries/>
    <AnalysisSeries algorithms={[Algorithms.bubbleSort]} dataSets={[DataSets.reversed]}/>
</ComplexityChart>
