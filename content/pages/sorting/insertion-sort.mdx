...
<ComplexityChart title="Time complexity of Insertion Sort on a sorted list of numbers">
    <ComplexitySeries/>
    <AnalysisSeries id="insertion-sort-sorted" algorithms={[Algorithms.insertionSort]} dataSets={[DataSets.sorted]}/>
</ComplexityChart>
...
<ComplexityChart title="Time complexity of Insertion Sort on a random list of numbers">
    <ComplexitySeries/>
    <AnalysisSeries id="insertion-sort-random" algorithms={[Algorithms.insertionSort]} dataSets={[DataSets.random]}/>
</ComplexityChart>
...
<ComplexityChart title="Time complexity of Insertion Sort on a reversed list of numbers">
    <ComplexitySeries/>
    <AnalysisSeries id="insertion-sort-reversed" algorithms={[Algorithms.insertionSort]} dataSets={[DataSets.reversed]}/>
</ComplexityChart>
