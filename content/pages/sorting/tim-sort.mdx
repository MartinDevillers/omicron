...
<ComplexityChart title="Time complexity of Tim Sort on a list of identical numbers">
    <ComplexitySeries/>
    <AnalysisSeries algorithms={[Algorithms.timSort]} dataSets={[DataSets.zeroes, DataSets.same]}/>
</ComplexityChart>
...
<ComplexityChart title="Time complexity of Tim Sort on sorted lists of numbers">
    <ComplexitySeries/>
    <AnalysisSeries algorithms={[Algorithms.timSort]} dataSets={[DataSets.sorted, DataSets.reversed, DataSets.square]}/>
</ComplexityChart>
...
<ComplexityChart title="Time complexity of Tim Sort on semi sorted lists of numbers">
    <ComplexitySeries/>
    <AnalysisSeries algorithms={[Algorithms.timSort]} dataSets={[DataSets.sortedHalf, DataSets.halfSorted, DataSets.zigzag, DataSets.semiSorted, DataSets.sawtooth ]}/>
</ComplexityChart>
...
<ComplexityChart title="Time complexity of Tim Sort on three blended lists of numbers">
    <ComplexitySeries/>
    <AnalysisSeries algorithms={[Algorithms.timSort]} dataSets={DataSets.repeat(DataSets.blender, 3, false)} />
</ComplexityChart>
...
<ComplexityChart title="Time complexity of Tim Sort on a random list of numbers">
    <ComplexitySeries/>
    <AnalysisSeries algorithms={[Algorithms.timSort]} dataSets={[DataSets.random]}/>
</ComplexityChart>
