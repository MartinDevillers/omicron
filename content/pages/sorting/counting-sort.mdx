...
<ComplexityChart title="Time complexity of Counting Sort on a random, sorted and reversed list of numbers">
    <ComplexitySeries/>
    <AnalysisSeries algorithms={[Algorithms.countingSort]} dataSets={[DataSets.random, DataSets.sorted, DataSets.reversed]}/>
</ComplexityChart>
...
<ComplexityChart title="Time complexity of Counting Sort on a list of identical numbers">
    <ComplexitySeries/>
    <AnalysisSeries algorithms={[Algorithms.countingSort]} dataSets={[DataSets.zeroes, DataSets.same]}/>
</ComplexityChart>
...
<ComplexityChart title="Time complexity of Counting Sort on a list of high variance">
    <ComplexitySeries/>
    <AnalysisSeries algorithms={[Algorithms.countingSort]} dataSets={[DataSets.thousands, DataSets.millions]}/>
</ComplexityChart>
