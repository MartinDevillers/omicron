...
<ComplexityChart title="Time complexity of Heap Sort on a variety of lists of numbers">
    <ComplexitySeries/>
    <AnalysisSeries algorithms={[Algorithms.heapSort]} dataSets={[DataSets.random, DataSets.sorted, DataSets.reversed, DataSets.millions, DataSets.zigzag, DataSets.sawtooth, DataSets.semiSorted]}/>
</ComplexityChart>
...
<ComplexityChart title="Time complexity of Heap Sort on a list of identical numbers">
    <ComplexitySeries/>
    <AnalysisSeries algorithms={[Algorithms.heapSort]} dataSets={[DataSets.same, DataSets.zeroes, DataSets.combine(DataSets.same, DataSets.zeroes)]}/>
</ComplexityChart>
