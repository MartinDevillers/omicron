...
<ComplexityChart title="Time complexity of Quick Sort on a random list of numbers">
    <ComplexitySeries/>
    <AnalysisSeries algorithms={[Algorithms.quickSort]} dataSets={[DataSets.random]}/>
</ComplexityChart>
...
<ComplexityChart title="Time complexity of Quick Sort on a sorted list of numbers">
    <ComplexitySeries/>
    <AnalysisSeries algorithms={[Algorithms.quickSort]} dataSets={[DataSets.sorted]}/>
</ComplexityChart>
...
<ComplexityChart title="Time complexity of Quick Sort on a several blended lists of numbers">
    <ComplexitySeries/>
    <AnalysisSeries algorithms={[Algorithms.quickSort]} dataSets={DataSets.repeat(DataSets.blender, 3, true)} scatter={true} sizes={[1000, 1250, 1500, 1750, 2000, 2250, 2500, 2750, 3000, 3500, 4000, 4500, 5000]}/>
</ComplexityChart>
