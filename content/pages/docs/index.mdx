...
import analysisQuickSortRandom from "./analysis-quick-sort-random.json"
...
<ComplexityChart title="Time complexity of Quick Sort on a random set of numbers">
    <ComplexitySeries/>
    <AnalysisSeries data={analysisQuickSortRandom} algorithms={[Algorithms.quickSort]} dataSets={[DataSets.random]}/>
</ComplexityChart>
